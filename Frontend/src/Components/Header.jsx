...
import InwardRecords from "./InwardRecords";
            ...
            <React.Fragment>
              <div className="wrapper">
                  ...
                  <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown">
                      ...
                      <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div className="dropdown-divider"></div>
                        <a href="#" className="dropdown-item">
                          <i className="fas fa-envelope mr-2"></i> 4 new
                          messages
                        ...
                        <div className="dropdown-divider"></div>
                        <a href="#" className="dropdown-item">
                          <i className="fas fa-users mr-2"></i> 8 friend
                          requests
                          <span className="float-right text-muted text-sm">
                            12 hours
                          </span>
                ...
                <aside className="main-sidebar sidebar-dark-primary elevation-4">
                  ...
                  <a href="index3.html" className="brand-link">
                    <img
                      ...
                      alt="AdminLTE Logo"
                      className="brand-image img-circle elevation-3 a1"
                    />
               ...
               with font-awesome or any other icon font library --> */}
                        <li className="nav-item menu-open">
                          ...
                          <Link to="/ProductMaster" className="nav-link">
                                {" "}
                                <i className="far fa-circle nav-icon"></i>Product Master
                              </Link>
                            <li className="nav-item">
                            <Link to="/Product" className="nav-link">
                                {" "}
                                <i className="far fa-circle nav-icon"></i>Product
                              </Link>
                            </li>
                            <li className="nav-item">
                            <Link to="/LedgerMaster" className="nav-link">
                                {" "}
                                <i className="far fa-circle nav-icon"></i>Ledger Master
                              </Link>
                            </li>
                            <li className="nav-item">
                            <Link to="/InwardRecords" className="nav-link">
                                {" "}
                                <i className="far fa-circle nav-icon"></i>Inward Records
                              </Link>
                            </li>
                            <li className="nav-item">
                            <Link to="/Stock" className="nav-link">
                                {" "}
                                <i className="far fa-circle nav-icon"></i>Stock
                              </Link>
                            </li>
                          </ul>
                        </li>
              ...
              <div className="main-panel">
                <div className="main-content">
                  <Route exact path="/ProductMaster">
                    <ProductMaster />
                  </Route>
                  <Route exact path="/Product">
                    <Product />
                  </Route>
                  <Route exact path="/LedgerMaster">
                    <LedgerMaster />
                  </Route>
                  <Route exact path="/InwardRecords">
                    <InwardRecords />
                  </Route>
